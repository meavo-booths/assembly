/**
 * Canonical mapping of Assembly fields to Google Sheet columns (A–O).
...
/** Last mapped column index (O). Column N (13) is skipped. */
export const ASSEMBLY_SHEET_LAST_COLUMN_INDEX = 14;
